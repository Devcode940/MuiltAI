...
/** Owns reusable WebView lifecycle operations used by browser tabs. */
class WebViewEngine {
    /** Saves navigation state into a caller-owned bundle before configuration/process recreation. */
